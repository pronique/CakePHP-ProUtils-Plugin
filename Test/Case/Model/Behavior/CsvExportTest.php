<?php
App::uses('CsvExportBehavior', 'ProUtils.Model/Behavior');
 ...
 */
class CsvExportTest extends CakeTestCase {
/**
 * fixtures property
 *
 * @var array
 * @access public
 */
	public $fixtures = array('plugin.proutils.content');
 ...
 */
	/* public function testImportCSV() {
		$this->Content->Behaviors->attach('Utils.CsvExport');
